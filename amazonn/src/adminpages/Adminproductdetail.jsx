    ...
    return (
        <div className='Mainproductbox'>
            ...
            <div className='paymentproductbox'>
                <img className='paymebtimageamazon' 
                src={Logo}
                        alt=''
                    />
                {/* <h1>AmaZonn</h1> */}
